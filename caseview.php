...
<html class="no-js"> 
    ...
    if (!empty($susp_r)) {
        ...
        <div class="form-group row">
            <label class="col-form-label tab">Fingerprint:
                <table class="offset-lg-2 table table-center table-bordered tab">
                    ...
                    echo '<tr>';
                    echo '<td>';
                    if (!empty($susp_r['FINGERPRINT'])) {
                        echo '<img src="data:image/jpeg;base64,' . base64_encode($susp_r['FINGERPRINT']) . '" height="200" width="200" class="img-thumnail" />';
                    } else {
                        echo 'No fingerprint available';
                    }
                    echo '</td>';
                    echo '</tr>';
                    ?>
        ...
        echo 'No suspect information available';
    }
    ?>
</section>
